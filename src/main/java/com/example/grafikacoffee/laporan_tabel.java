...
public class laporan_tabel implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            preparedStatement = DBUtils.getConnect().prepareStatement("SELECT * FROM tb_laporan");
            ...
            preparedStatement = DBUtils.getConnect().prepareStatement("SELECT SUM(total_terjual) AS totalTerjual FROM tb_laporan");
            ...
            preparedStatement = DBUtils.getConnect().prepareStatement("SELECT SUM(pemasukan) AS pendapatan FROM tb_laporan");
