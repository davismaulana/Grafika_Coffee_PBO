...
public class item_data_transaksi implements Initializable {
    @FXML
    ...
    public void setDataTransaksi(String nama_menu, int jumlah, int harga, int total){
        namaBarangLabel.setText(nama_menu);
